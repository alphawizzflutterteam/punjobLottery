              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                                                  ...
                                                  children: [
                                                    Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        SizedBox(height: 3,),
                                                         Text(getResultModel!.data!.lotteries![index].winners!.length == 0 ? "" :
                                                         "₹${getResultModel!.data!.lotteries![index].winners![0].winnerPrice}",style: TextStyle(color: AppColors.whit),),
                                                        SizedBox(height: 3,),
                                                         Container(
                                                           width: 90,
                                                             child: Text(getResultModel!.data!.lotteries![index].winners!.length == 0 ? "" : getResultModel!.data!.lotteries![index].winners![0].userName??"",style: TextStyle(color: AppColors.whit),maxLines: 1,overflow: TextOverflow.ellipsis,)),
                                                      ],
                                                    ),
                                                    ClipRRect(
                                                      borderRadius: BorderRadius.circular(10),
                    ...
                    lotteryModel!.data!.lotteries!.length ==  0 ? Center(child: Text("No Data Found!!")): userId=='71'?  Center(child: Text("No data Found"),) : Padding(
