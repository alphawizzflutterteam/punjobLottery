...
class _MyBookingsScreenState extends State<MyBookingsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:  userId=='71' ? Center(child: Text("No data Found"),) :
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    onTap: () {
                                      Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  ContestDetails(gId: myLotteryModel!.data!.lotteries![index].gameId)
                                          )
                                      );
                                    },
                                        child: Padding(
                                                      ...
                                                      children: [
                                                        Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            SizedBox(height: 5,),
                                                            Text("Price : ${myLotteryModel!.data!.lotteries![index].ticketPrice}",style: TextStyle(color: AppColors.black,fontSize: 16),),
                                                            // SizedBox(height: 3,),
