...
class Data {
  Data({
      ...
      List<Lotteries>? lotteries,
        List<LotteryDetailData>? lotteryDetailData

  }){
    _name = name;
    _lotteries = lotteries;
    _lotteryDetailData = lotteryDetailData ;
  ...
  Data.fromJson(dynamic json) {
    ...
    if (json['lotteries'] != null) {
      ...
      if (json['new'] != null) {
        _lotteryDetailData = <LotteryDetailData>[];
        json['new'].forEach((v) { _lotteryDetailData!.add( LotteryDetailData.fromJson(v)); });
      }
    }
  }
  String? _name;
  List<Lotteries>? _lotteries;
  List<LotteryDetailData>? _lotteryDetailData;
Data copyWith({  String? name,
  List<Lotteries>? lotteries,
  List<LotteryDetailData>? lotteryDetailData,
}) => Data(  name: name ?? _name,
  lotteries: lotteries ?? _lotteries,
  lotteryDetailData: lotteryDetailData ?? _lotteryDetailData
);
  String? get name => _name;
  List<Lotteries>? get lotteries => _lotteries;
  List<LotteryDetailData>? get lotteryDetailData => _lotteryDetailData;
...
class LotteryDetailData {
  ...
  LotteryDetailData({this.id, this.gameId, this.lotteryNumber, this.userId, this.bookStatus, this.purchaseStatus});

  LotteryDetailData.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    gameId = json['game_id'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['purchase_status'] = purchaseStatus;
    return data;
  }
}